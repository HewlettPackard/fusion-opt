...
n_init_pref = 500      # number of initial random samples for preferential learning #500 for svm
...
with open(f'evaluations/meta_{dataset}_na1.pkl', 'wb') as file: #rpart v1 evaluated on ckpt 50000, best one so far sample = False, na3 = we 0.5, na20 = 0.5
    pickle.dump(total_trajectories, file)                       #ranger9 sv6 x_field sample=False 390k na20 we = 0.7
                                                                ...
                                                                #xgboost sv6 x_field sample=False 460k, na3 we = 0.5 works
                                                                #battery na11 we = 0.7, na12/6 we = 0.3
                                                                
with open(f'evaluations/meta_{dataset}_na1_Y0.pkl', 'wb') as file: #ranger6D sv1 whole test_X, sv2 100 samples test_X, sv3 validation 100.
    pickle.dump(Y_0_total, file)

with open(f'evaluations/meta_{dataset}_na1_Y1.pkl', 'wb') as file: 
    pickle.dump(Y_1_total, file)