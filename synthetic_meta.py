...
model_name = 'tnpa'
ckpt_path = osp.join(results_path, dataset, model_name, '518000_ckpt.tar')
...
samples_val_X, samples_val_y = sample_from_training(X_validation_, y_validation_, max_points=20)
...
# print("X_test_: ", X_test_[0].shape)
# print("X_test_: ", X_test_[1].shape)
# print("X_test_: ", X_test_[2].shape)
# print("X_test_: ", X_test_[3].shape)
# print("X_test_: ", X_test_[4].shape)
# print("X_test_: ", X_test_[5].shape)
# sys.exit()
#X_t_fit, y_t_fit = sample_from_training(X_test_,y_test_, max_points = 230000)
best_values = []
total_trajectories = []
for i in range(len(X_test)):
    ...
    benchmark = Benchmark(X_test_[i], y_test_[i], sample=True)
    # print(y_test[i])
...
with open(f'evaluations/meta_{dataset}_sv6.pkl', 'wb') as file: #rpart v1 evaluated on ckpt 50000, best one so far
    pickle.dump(total_trajectories, file)                       #sv2 ranger6D evaluated on 749k, sv1 same but with beta_init = 0.5
                                                                #ranger9 sv6 x_field sample=False 
                                                                #ranger6D sv6 x_field sample=False 760k
                                                                #svm x_field sample = False 518k