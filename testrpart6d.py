...
model_name = 'tnpa'
ckpt_path = osp.join(results_path, dataset, model_name, '50000_ckpt.tar') #rpart_50k was best #ranger9_v1: 290000,
...
with open(f'evaluations/meta_{dataset}_rparts22.pkl', 'wb') as file: #rpart v1 evaluated on ckpt 50000, best one so far v2 best evaluation for rpart #ranger9 v2 100k, v3 100k flip
