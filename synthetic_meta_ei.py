...
#plt.show()
from CoExBO._coexbo_ei import CoExBOwithSimulation, StateManager
...
with open(f'evaluations/meta_{dataset}_sv6_ei.pkl', 'wb') as file: #rpart v1 evaluated on ckpt 50000, best one so far 
    pickle.dump(total_trajectories, file)                           #range9  sv1 100k new aei noise = 0.1, sv2 100k noise = 0.2, sv3 20k noise=0.2, sv4 20k noise=0.2 sample = False, sv5 390k noise = 0.2 sample = False
                                                                    #ranger9 sv6 390k  noise = 0.2 sample = False x_field
                                                                    #ranger6 sv6 noise = 0.2 sample = False x_field 760k